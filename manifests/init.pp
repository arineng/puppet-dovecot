...
class dovecot (
  ...
  $auth_listener_master_mode     = undef,
  $auth_listener_master_user     = undef,
  $auth_listener_master_group    = undef,
  ...
  $auth_passwdfile_userdb_driver = undef,
  # auth-sql.conf.ext
  ...
  $first_valid_gid               = false,
  $last_valid_gid                = false,
  $manage_service                = true,
